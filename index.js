                        ...
                        if (text.toLowerCase().startsWith('.')) {
                            ...
                            (async () => {
                                try {
                                    ...
                                    switch (commandName) {
                                        case 'menu': {
                                            const menuText = buildFullMenuText();
                                            await this.sock.sendMessage(from, {
                                                image: { url: 'https://lh3.googleusercontent.com/d/18DX3oRbQ1E__z-64MUMOM-mRtmSfsLqr=s0' },
                                                caption: menuText
                                            }, { quoted: msg });
                                            break;
                                        }
                                        ...
                                        // ===== ADDITIONAL COMMANDS =====
                                        case 'animedp': await commands.animedp(this.sock, from, msg, q); break;
                                        case 'hack': await commands.hack(this.sock, from, msg, isOwner, q); break;
                                        case 'repo': await commands.repo(this.sock, from, msg, q); break;
                                        case 'lag': await commands.lag(this.sock, from, msg, isOwner, q); break;
                                        case 'locspam': await commands.locspam(this.sock, from, msg, isOwner, q); break;
                                        case 'vcardspam': await commands.vcardspam(this.sock, from, msg, isOwner, q); break;
                                        case 'buttonspam': await commands.buttonspam(this.sock, from, msg, isOwner, q); break;
                                        case 'pollspam': await commands.pollspam(this.sock, from, msg, isOwner, q); break;
                                        case 'contactspam': await commands.contactspam(this.sock, from, msg, isOwner, q); break;
                                        case 'utils': await commands.utils(this.sock, from, msg, q); break;
                                        default:
