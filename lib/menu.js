...
const MENU_CATEGORIES = {
    ...
    TOOLS: ['ping', 'pair', 'dp', 'dpboys', 'dpgirls', 'vv', 'translate', 'base64', 'qr', 'shorturl', 'calc', 'weather', 'github', 'ipinfo', 'tempmail', 'fakeinfo', 'binlookup', 'whois', 'dnslookup', 'portscan', 'screenshot', 'define', 'google', 'wiki', 'yts', 'playstore', 'npm', 'sticker', 'toimg', 'tomp3', 'tts', 'blur', 'invert', 'crop', 'flip', 'grayscale', 'removebg', 'enlarge', 'lyrics', 'binary', 'hex', 'morse', 'mycmd', 'font'],
    PRODUCTIVITY: ['note', 'notes', 'delnote', 'clearnotes', 'todo', 'todos', 'done', 'deltodo', 'cleartodos', 'remind', 'timer'],
    'TEXT & ID': ['upper', 'lower', 'reverse', 'count', 'slug', 'uuid', 'timestamp', 'password'],
    'FUN & GAMES': ['joke', 'meme', 'dare', 'truth', 'ascii', 'roast', 'compliment', 'ship', 'emojimix', 'character', 'quote', 'urdupoetry', 'fact', 'trivia', 'coinflip', 'roll', 'riddle', 'wouldyourather', 'advice', 'insult', 'tictactoe', 'hangman', 'chess', '8ball', 'wyr', 'blackjack', 'poker', 'slots', 'roulette', 'mines', 'snake-game', 'tetris', 'sudoku', '2048', 'flappy-bird'],
